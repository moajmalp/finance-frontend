                ...
                <AnimatePresence mode="wait">
                    {isOpen && (
                        <motion.div
                            ...
                            className="absolute z-50 mt-2 w-[calc(100vw-2rem)] sm:w-80 p-5 bg-card/95 backdrop-blur-xl rounded-[2.5rem] shadow-premium border border-border origin-top left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-0"
                        >
